...
import { addUserToBoard, getBoardById, getBoardMembers } from "../../../api/boardApi";
...
function BoardPage({boardId, boardTitle}){
    ...
    return (
        <div className="App">
        <h1>{boardTitle}</h1>
        <BoardBar setSearchTerm={setSearchTerm} setSelectedTag={setSelectedTag} setSelectedMember={setSelectedMember} boardId={boardId} members={members} onAddMember={onAddMember}/>
